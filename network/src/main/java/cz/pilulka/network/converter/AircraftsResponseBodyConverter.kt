...
import cz.pilulka.extension.simpleName
import cz.pilulka.network.call.Resource
import cz.pilulka.network.mapper.DataMappedFrom
import cz.pilulka.network.mapper.DataMappingException
import cz.pilulka.network.mapper.ResponseMapper
...
class AircraftsResponseBodyConverter<T, R>(private val moshi: Moshi, private val type: Type) :
