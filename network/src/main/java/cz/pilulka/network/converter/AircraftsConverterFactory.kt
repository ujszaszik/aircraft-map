package cz.pilulka.network.converter
...
class AircraftsConverterFactory private constructor(
    ...
    override fun responseBodyConverter(
        ...
        return AircraftsResponseBodyConverter<Any, Any>(moshi, type)
    }
    ...
    override fun requestBodyConverter(
        ...
        return AircraftsRequestBodyConverter(adapter)
    }

    companion object {
        @JvmOverloads
        fun create(moshi: Moshi? = Moshi.Builder().build()): AircraftsConverterFactory {
            return moshi?.let {
                AircraftsConverterFactory(it)
