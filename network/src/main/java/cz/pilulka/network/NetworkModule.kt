...
import cz.pilulka.network.call.ResourceCallAdapterFactory
import cz.pilulka.network.converter.AircraftsConverterFactory
...
class NetworkModule {
    ...
    fun provideRetrofit(
        ...
        converterFactory: AircraftsConverterFactory,
    ...
    @Provides
    @Singleton
    fun provideConverterFactory(moshi: Moshi): AircraftsConverterFactory =
        AircraftsConverterFactory.create(moshi)
